...
class DataViewer:
    ...
    def update(self, true_state, estimated_state, commanded_state, delta, ts):
        ...
        true_state_list = [true_state.p.item(0), true_state.p.item(1), -true_state.p.item(2),
                           true_state.v.item(0), true_state.v.item(1), true_state.v.item(2),
                           phi, theta, psi,
                           true_state.omega.item(0), true_state.omega.item(1), true_state.omega.item(2),
                           0, 0, 0]
        phi_e, theta_e, psi_e = rotation_to_euler(estimated_state.R)
        estimated_state_list = [estimated_state.p.item(0), estimated_state.p.item(1), -estimated_state.p.item(2),
                           estimated_state.v.item(0), estimated_state.v.item(1), estimated_state.v.item(2),
                           phi_e, theta_e, psi_e,
                           estimated_state.omega.item(0), estimated_state.omega.item(1), estimated_state.omega.item(2),
                           0, 0, 0]
        phi_c, theta_c, psi_c = rotation_to_euler(commanded_state.R)
        commanded_state_list = [commanded_state.pos.item(0), commanded_state.pos.item(1), -commanded_state.pos.item(2),
                           ...
                           phi_c, theta_c, psi_c]
        delta_list = [delta[0][0], delta[1].item(0), delta[1].item(1), delta[1].item(2)]
